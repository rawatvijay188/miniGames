...
export default function SlotGames() {
  return (
    <main className="platform-shell">
      <section className="platform-hero" aria-labelledby="slotGamesTitle">
        <div className="hero-copy">
          <button className="back-link" type="button" onClick={() => navigateTo("home")}>
            ← Back to Game Hub
          </button>
          <p className="kicker">All games</p>
          <h1 id="slotGamesTitle">Slot Games</h1>
          <p>Explore every game from classic reels to puzzle and arcade tables, all inside one deck.</p>
        </div>
      ...
      <section className="slot-games-grid" aria-label="Available games">
